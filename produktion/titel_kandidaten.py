...
Unterschiede:
  ...
  1. Es wird gegen ZWEI Mengen geprueft: die 21 Gewinner-Titel (Regel V3,
...
def main():
    ...
    print(f"Grenze {a.grenze*100:.0f} %  |  {len(gewinner)} Gewinner-Titel, "
          f"{len(eigene)} eigene veroeffentlichte Titel "
          f"({len(gewinner)+len(eigene)} Vergleichstitel gesamt)\n")
